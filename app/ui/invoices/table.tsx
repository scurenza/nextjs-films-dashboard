...
import { fetchFilteredFilms, fetchFilteredInvoices } from "@/app/lib/data";
import { Progress } from "@/components/ui/progress";
import { DaVedere, Visto } from "./buttons";
...
export default async function InvoicesTable({
  ...
  //     {
  //       adult: false,
  //       backdrop_path: "/2P3FyI9ZTe9duRIGpGPiDC3mQMf.jpg",
  //       genre_ids: [99, 10770],
  //       id: 1217455,
  //       original_language: "fr",
  //       original_title: "Matrix génération",
  //       overview:
  ...
  //       popularity: 3.3819,
  //       poster_path: "/53McB8R9RUBxfINRxWaPwUMtL5Q.jpg",
  //       release_date: "2023-12-13",
  //       title: "The Matrix: Generation",
  //       video: false,
  //       vote_average: 7.4,
  //       vote_count: 15,
  //     },
  ...
  //       adult: false,
  //       backdrop_path: null,
  //       genre_ids: [28, 12, 27, 14],
  //       id: 107392,
  //       original_language: "zh",
  //       original_title: "小俠龍捲風",
  //       overview:
  ...
  //       popularity: 0.2053,
  //       poster_path: "/iq8zeotrIDwjViRgnISwEwHJQ87.jpg",
  //       release_date: "1988-12-09",
  //       title: "Chess Boxing Matrix",
  //       video: false,
  //       vote_average: 6.25,
  //       vote_count: 8,
  //     },
  ...
  //       overview: "",
  //       popularity: 0.465,
  //       poster_path: "/2s3y8p1P3HIeQz3mmPQxQPXMVJj.jpg",
  //       release_date: "",
  //       title: "Matrix 5",
  //       video: false,
  //       vote_average: 0,
            ...
            <tbody className="bg-white">
              {films?.results.map((film: any) => (
                ...
                >
                  ...
                  {/* <td className="whitespace-nowrap px-3 py-3">
                    {formatCurrency(film.amount)}
                  </td> */}
                  <td className="whitespace-nowrap px-3 py-3">
                    {formatDate(film.release_date)}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {/* <FilmStatus status={film.status} /> */}
                    {film.vote_average > 0 && (
                      <>
